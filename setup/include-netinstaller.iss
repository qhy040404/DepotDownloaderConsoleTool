...
Source: "J:\VSProjs\DepotDownloaderConsoleTool\res\runtime-x64.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "J:\VSProjs\DepotDownloaderConsoleTool\res\runtime-x86.exe"; DestDir: "{app}"; Flags: ignoreversion
